...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(sixCycleCpp(sender, currentSender, target, currentTarget, typevar, currentType, time, currentTime, weightvar, xlog, attrvarAaj, attrAaj, attrvarBib, attrBib, attrvarCij, attrCij, fourCycleType, w, x, i, begin));
...
static const R_CallMethodDef CallEntries[] = {
    {"_rem_sixCycleCpp", (DL_FUNC) &_rem_sixCycleCpp, 21},
